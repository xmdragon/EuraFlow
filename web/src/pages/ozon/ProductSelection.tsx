                      ...
                      items={[
                        ...
                        },
                        {
                          ...
                          children: (
                            ...
                            >
                              <Alert
                                message="🖨️ EuraFlow 打印助手"
                                description="浏览器扩展，支持PDF标签静默打印到默认打印机，无需确认对话框，提升打包发货效率。"
                                type="success"
                                showIcon
                              />
                              ...
                              <Card title="✨ 核心特性" size="small">
                                <Row gutter={[16, 16]}>
                                  ...
                                  <Col span={12}>
                                    <Alert
                                      message="Edge/Chrome 兼容"
                                      description="基于 Chromium Printing API，支持主流浏览器"
                                      type="info"
                                      showIcon
                                    />
                                  </Col>
                                  <Col span={12}>
                                    <Alert
                                      message="安全隔离"
                                      description="仅响应来自 EuraFlow 系统的打印请求"
                                      type="info"
                                      showIcon
                                    />
                                  </Col>
                                  <Col span={12}>
                                    <Alert
                                      message="自动配置"
                                      description="默认黑白单面打印，适配 OZON 标签尺寸"
                                      type="info"
                                      showIcon
                                    />
                                  </Col>
                                      ...
                                      description: (
                                        <Space direction="vertical">
                                          <Button
                                            type="primary"
                                            icon={<DownloadOutlined />}
                                            href="/downloads/euraflow-print-helper-v1.0.0.zip"
                                            download
                                          >
                                            下载打印助手扩展 v1.0.0
                                          </Button>
                                    ...
                                    },
                                    {
                                      ...
                                      description: (
                                        <div>
                                          <Paragraph>
                                            1. 打开 Chrome 浏览器，访问{" "}
                                            <Text code>chrome://extensions/</Text>
                                          </Paragraph>
                                          <Paragraph>
                                            2. 开启右上角的"开发者模式"
                                          </Paragraph>
                              ...
                              <Card title="🚀 使用方法" size="small">
                                <Timeline
                                  items={[
                                    {
                                      children: "打开 EuraFlow 打包发货页面",
                                      color: "blue",
                                    },
                                    {
                                      children: '扫描单号并点击"打印标签"',
                                      color: "blue",
                                    },
                                    {
                                      children: '在打印标签弹窗中点击"打印"按钮',
                                      color: "green",
                                    },
                                    {
                                      children: "PDF 自动发送到默认打印机，无需确认",
                                      color: "green",
                                    },
                                  ]}
                                />
                              ...
                              {/* 打印配置 */}
                              <Card title="⚙️ 打印配置" size="small">
                                <Descriptions bordered column={1} size="small">
                                  <Descriptions.Item label="打印机">
                                    系统默认打印机
                                  </Descriptions.Item>
                                  <Descriptions.Item label="纸张尺寸">
                                    100mm x 150mm（OZON 标签标准尺寸）
                                  </Descriptions.Item>
                                  <Descriptions.Item label="打印方向">
                                    纵向（PORTRAIT）
                                  </Descriptions.Item>
                                  <Descriptions.Item label="颜色模式">
                                    黑白（MONOCHROME）
                                  </Descriptions.Item>
                                  <Descriptions.Item label="打印面数">
                                    单面（NO_DUPLEX）
                                  </Descriptions.Item>
                                  <Descriptions.Item label="打印份数">
                                    1 份
                                  </Descriptions.Item>
                                  <Descriptions.Item label="打印质量">
                                    300 DPI
                                  </Descriptions.Item>
                                  <Descriptions.Item label="页面适配">
                                    调整为可打印区域大小（FIT_TO_PAGE）
                                  </Descriptions.Item>
                                </Descriptions>
                                <Paragraph style={{ marginTop: 16 }}>
                                  <Text type="secondary">
                                    如需修改配置，请编辑扩展目录中的{" "}
                                    <Text code>background/service-worker.js</Text>{" "}
                                    文件的 ticket 配置部分。
                                  </Text>
                                </Paragraph>
                              </Card>
                                  ...
                                  items={[
                                    {
                                      ...
                                      children: (
                                        <div>
                                          <Paragraph>请检查：</Paragraph>
                                          <ul>
                                            <li>扩展是否已启用（访问 edge://extensions/ 检查状态）</li>
                                            <li>刷新 EuraFlow 页面</li>
                                            <li>打开浏览器控制台，查看是否有 [EuraFlow Print Content] 日志</li>
                                          </ul>
                                        </div>
                                      ),
                                    },
                                      ...
                                      children: (
                                        <div>
                                          ...
                                          <ul>
                                            <li>默认打印机是否已设置</li>
                                            <li>确认打印机处于就绪状态</li>
                                            <li>打开扩展的后台页面查看错误日志：edge://extensions/ → EuraFlow 打印助手 → "服务工作进程" → "检查视图"</li>
                                          </ul>
                                        </div>
                                      ),
                                    },
                                    {
                                      ...
                                      children: (
                                        <div>
                                          ...
                                          <Paragraph>
                                            Background 日志：edge://extensions/ → EuraFlow 打印助手 → "服务工作进程" → "检查视图"
                                          </Paragraph>
                                        </div>
                                      ),
                                    },
                                      ...
                                      children: (
                                        <div>
                                          <Paragraph>
                                            支持。编辑扩展目录中的{" "}
                                            <Text code>background/service-worker.js</Text>{" "}
                                            文件，修改第 38-64 行的 ticket 配置部分，然后在{" "}
                                            <Text code>edge://extensions/</Text>{" "}
                                            页面点击刷新图标重新加载扩展。
                                          </Paragraph>
                                        </div>
