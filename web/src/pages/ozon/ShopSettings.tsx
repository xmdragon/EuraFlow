...
import {
  Card, Form, Input, Button, Space, Tabs, Switch,
  message, Alert, Divider, Select, InputNumber,
  Typography, Row, Col, Statistic, Badge, Modal,
  Table, Tag, Tooltip, Spin
} from 'antd'
import {
  ShopOutlined, KeyOutlined, ApiOutlined,
  ...
  const saveShopMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      form.setFieldsValue({
        ...
        api_key: currentApiKey && currentApiKey !== '******' ? currentApiKey : data.api_credentials?.api_key,
          ...
          <Table
            ...
            columns={[
              ...
              },
              {
                title: '商品数',
                key: 'products',
                render: (_, record) => record.stats?.total_products || 0
              },
              {
                title: '订单数',
                key: 'orders',
                render: (_, record) => record.stats?.total_orders || 0
              },
              {
                title: '最后同步',
                key: 'last_sync',
          ...
          <>
            ...
            >
              <Tabs 
                ...
                items={[
                  {
                    label: <span><KeyOutlined /> API配置</span>,
                    key: '1',
                    children: (
                      <>
                        <Row gutter={16}>
                  ...
                  {
                    label: <span><SyncOutlined /> 同步设置</span>,
                    key: '2',
                    children: (
                      <>
                        <Row gutter={16}>
                  ...
                  />
                        ...
                        <Button type="dashed" style={{ marginTop: 16, width: '100%' }} icon={<PlusOutlined />}>
                          添加仓库映射
                        </Button>
                      </>
                    )
              ...
              <Form.Item>
                <Space>
                  <Button type="primary" htmlType="submit" icon={<SaveOutlined />} loading={saveShopMutation.isPending}>
                    保存配置
                  </Button>
        ...
        >
          ...
          <Form.Item>
            <Space>
              ...
              <Button onClick={() => setAddShopModalVisible(false)}>
                取消
              </Button>
            </Space>
          </Form.Item>
