...
class OzonProduct(Base):
    ...
    __table_args__ = (
        UniqueConstraint("shop_id", "sku", name="uq_ozon_product_shop_sku"),
    )
    ...
    offer_id: Mapped[str] = mapped_column(
        String(100),
        nullable=False,
        comment="Ozon Offer ID"
    )
    
    ozon_product_id: Mapped[Optional[int]] = mapped_column(
        BigInteger,
        nullable=True,
        comment="Ozon Product ID"
    )
    
    ozon_sku: Mapped[Optional[int]] = mapped_column(
        BigInteger,
        nullable=True,
        comment="Ozon SKU"
    )
    ...
    premium_price: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(18, 4),
        nullable=True,
        comment="会员价"
    )
