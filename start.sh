...
echo "  - Background Services: Integrated in backend (auto-started)"
echo "  - Supervisor Web: http://localhost:9001 (admin/admin123)"
echo ""
echo "Background Sync Services:"
echo "  - Manage at: http://localhost:8000/dashboard/ozon/sync-services"
echo "  - Services run automatically when enabled"
echo ""
